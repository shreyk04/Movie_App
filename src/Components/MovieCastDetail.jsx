          ...
          <div className="column">
            <div className="full-wrapper">
              ...
              <div className="personal-info-section">
                <p>
                  {" "}
                  <strong>Known For</strong> {cast && cast.known_for_department}
                </p>
                <p>
                  {" "}
                  <strong>Gender</strong>{" "}
                  {cast && genderNumberToNameMapping[cast.gender]}{" "}
                </p>
                <p>
                  {" "}
                  <strong>Birthday</strong> {cast && cast.birthday}
                </p>
                <p>
                  {" "}
                  <strong>Place of Birth</strong> {cast && cast.place_of_birth}
                </p>
                <p>
                  {" "}
                  <strong>Also Known as</strong> {cast && cast.also_known_as}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="cast-biography">
            ...
            <p
              className={`biography-content ${
                showFullBiography ? "expanded" : ""
              }`}
            >
              {cast && cast.biography}
            </p>
            {cast.biography && cast.biography.length > 100 && (
              <button onClick={toggleBiography} className="see-more">
